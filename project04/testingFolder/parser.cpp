...
//                    std::cout << Scanner.getLexeme() << std::endl;
                    ...
                    if( initialVar == true ){
                        ...
                        if( STV.find( currentLexeme ) == 0 ){
                            //this means we've found the lexeme already inside the global stack
                            STV.setValue( currentLexeme, currentValue );
                        } else if( stack.find( currentLexeme ) == -1) {
                            //we've have nothing in our local stack and are inserting this into the local Stack
